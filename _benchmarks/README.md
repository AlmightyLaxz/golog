...
```bash
$ cd $GOPATH/src/github.com/almightylaxz/golog/_benchmarks
$ go get ./...
...
> Feel free to send a [PR](https://github.com/almightylaxz/golog/pulls) of your own loger benchmark to put it here!
